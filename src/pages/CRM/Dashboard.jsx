...
const periods = ["This Month", "Last Month", "This Quarter", "Last Quarter", "YTD", "Last Year"];
        ...
        <div className="flex items-center">
          <div className="relative" ref={periodRef}>
            <button
              ...
              className="flex items-center gap-2 rounded-lg border border-border bg-card px-3 py-2 text-sm font-medium text-foreground shadow-crm-sm hover:bg-muted transition-colors"
            >
              {selectedPeriod}
              <ChevronDown className={`h-4 w-4 text-muted-foreground transition-transform ${periodOpen ? "rotate-180" : ""}`} />
            </button>
            {periodOpen && (
